...
export const ui = {
	en: {
		...
		"contact.subtitle": "Pídele a nuestro asistente de IA que te agende una cita con nosotros o dile que nos envíe un correo",
		"contact.name": "Nombre",
	...
	it: {
		...
		"contact.subtitle": "Ask our AI assistant to schedule an appointment with us or tell it to send us an email",
		"contact.name": "Name",
		"contact.email": "Email",
